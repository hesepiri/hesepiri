...
- 🛠️ Bridging the gap between Cloud Infrastructure (AWS) and Modern Web Development.
- ⚡ Optimizing frontend performance and modular architecture.

### 🛠️ Tech Stack
- **Frontend:** JavaScript (ES6+), React, HTML5, CSS3.
- **Backend & Cloud:** AWS, DevOps principles, CI/CD.
- **Legacy & Support:** L3 Troubleshooting, Project Management, Global Team Collaboration.
